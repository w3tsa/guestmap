...
import { Card, Button, CardTitle, CardText, Form, FormGroup, Label, Input, Col } from 'reactstrap';
import './App.css';
...
const API_URL = window.location.hostname === 'localhost' ? 'http://localhost:5000/api/v1/messages' : 'https://guestmap-api.vercel.app/api/v1/messages'
    ...
    <Card body className='message-form'>
        ...
        <CardText>Thanks for stopping by</CardText>
          ...
          <Form onSubmit={formSubmitted}>
            ...
            <FormGroup row>
              <Label for="message" sm={5}>Message</Label>
              <Col sm={10}>
                <Input 
                onChange={handleChange} 
                type="textarea" 
            ...
            <Button color="info" type='submit' className='button' disabled={!userLocation.haveUsersLocation}>Submit</Button>
        </Form> : 
        loader.sendingMessage ? 
        <video autoPlay loop src='https://media.giphy.com/media/hWSQvXbDDh8rlnoLOt/giphy.mp4'></video>
        :
